...
def parse_command_line_args():
    ...
    parser.add_argument(
            '--private_key_file', default='rsa_private.pem', help='Path to private key file.')
    parser.add_argument(
            '--algorithm',
            default='RS256',
...
def main():
    ...
    for i in range(1, args.num_messages + 1):
        ...
        payload = 'xG:{}, yG:{}, zG:{}'.format(
                convertGx(convertVoltage(getReading(0))),convertGx(convertVoltage(getReading(1))),convertGx(convertVoltage(getReading(2))))
